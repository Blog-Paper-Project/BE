...
// 상세 페이지 이미지 첨부
router.post('/image', auth, upload.single('image'), asyncHandler(PaperController.createImage));
// 상세 페이지 수정
...
// 댓글 수정
router.patch('/:postId/comments/:commentId', auth, asyncHandler(PaperController.updateComment));
// 댓글 삭제
router.delete('/:postId/comments/:commentId', auth, asyncHandler(PaperController.deleteComment));
// 좋아요 등록 및 취소
